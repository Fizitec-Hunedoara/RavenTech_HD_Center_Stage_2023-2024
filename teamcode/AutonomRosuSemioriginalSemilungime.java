...
public class AutonomRosuSemioriginalSemilungime extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (Objects.equals(varrez, "Mijloc")) {
            ts = drive.trajectorySequenceBuilder(startPose)
                    ...
                    .forward(7)
                    .lineToLinearHeading(new Pose2d(new Vector2d(53,-36),Math.toRadians(181.5)))
                    .build();

        }
        if (Objects.equals(varrez, "Stanga")){
            ts = drive.trajectorySequenceBuilder(startPose)
                    .lineToLinearHeading(new Pose2d(new Vector2d(5,-32), Math.toRadians(290)))
                    .lineToLinearHeading(new Pose2d(new Vector2d(11,-40),Math.toRadians(270)))
                    .waitSeconds(0.1)
                    .lineToLinearHeading(new Pose2d(new Vector2d(53,-32), Math.toRadians(181.5)))
                    .build();
        }
...
//                    .waitSeconds(0.2)
                    ...
                    .lineToLinearHeading(new Pose2d(new Vector2d(14,-44),Math.toRadians(250)))
                    .lineToLinearHeading(new Pose2d(new Vector2d(53,-44),Math.toRadians(181.5)))
                    .build();
        }
        ...
        ceva=true;
            ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                    .lineToLinearHeading(new Pose2d(new Vector2d(12,-61),Math.toRadians(182)))
                    .lineToLinearHeading(new Pose2d(new Vector2d(-54.5,-61),Math.toRadians(182)))
                    .build();
            drive.followTrajectorySequence(ts);
            p.kdf(300);
            ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
            ...
            ts = drive.trajectorySequenceBuilder(new Pose2d(new Vector2d(-59,-33),Math.toRadians(181.5)))
                    .lineToConstantHeading(new Vector2d(-57,-33))
                    .lineToLinearHeading(new Pose2d(new Vector2d(-55,-12),Math.toRadians(180)))
            ...
            if (varrez == "Mijloc"){
                ts = drive.trajectorySequenceBuilder(new Pose2d(new Vector2d(30,-10),Math.toRadians(180)))
                        .lineToLinearHeading(new Pose2d(new Vector2d(51,-35),Math.toRadians(180)))
                        .build();
            }
            else {
                ts = drive.trajectorySequenceBuilder(new Pose2d(new Vector2d(30,-10),Math.toRadians(180)))
                        .lineToLinearHeading(new Pose2d(new Vector2d(51,-37.5),Math.toRadians(180)))
                        .build();
            }
