...
public class AutonomHustonRosuMicut extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (Objects.equals(varrez, "Mijloc")) {
            ts = drive.trajectorySequenceBuilder(startPose)
                    ...
                    .forward(7)
                    .lineToLinearHeading(new Pose2d(new Vector2d(51.2,-37.5),Math.toRadians(180)))
                    .build();
        ...
        if (Objects.equals(varrez, "Stanga")){
            ts = drive.trajectorySequenceBuilder(startPose)
                    ...
                    .lineToLinearHeading(new Pose2d(new Vector2d(51.2,-32), Math.toRadians(180)))
                    .build();
        }
...
//                    .waitSeconds(0.2)
                    ...
                    .lineToLinearHeading(new Pose2d(new Vector2d(14,-43),Math.toRadians(250)))
                    .lineToLinearHeading(new Pose2d(new Vector2d(51.2,-43),Math.toRadians(180)))
                    .build();
        }
        ...
        ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(new Vector2d(39, -11.5), Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(new Vector2d(-59.55,-11.5),Math.toRadians(180)))
        ...
        p.kdf(250);
        p.kdf(400);
        ts = drive.trajectorySequenceBuilder(new Pose2d(new Vector2d(-59.55,-12.5),Math.toRadians(181)))
                .lineToLinearHeading(new Pose2d(new Vector2d(39,-10),Math.toRadians(180)))
                .build();
        drive.followTrajectorySequence(ts);
        p.setSugatorPower(0);
        new Thread(this::erectie).start();
        ts = drive.trajectorySequenceBuilder(new Pose2d(new Vector2d(39,-10),Math.toRadians(181)))
                .lineToLinearHeading(new Pose2d(new Vector2d(49.5,-32.3),Math.toRadians(180)))
                .build();
        drive.followTrajectorySequence(ts);
        p.kdf(50);
        new Thread(this::fata_spate).start();
        new Thread(this::disfunctieerectila).start();
        ts = drive.trajectorySequenceBuilder(new Pose2d(new Vector2d(49.5,-32.3),Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(new Vector2d(39, -11), Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(new Vector2d(-59,-11),Math.toRadians(180)))
                .build();
        drive.followTrajectorySequence(ts);
        p.kdf(100);
        p.setSugatorPower(-0.9);
        ...
        p.kdf(250);
        p.kdf(400);
        ts = drive.trajectorySequenceBuilder(new Pose2d(new Vector2d(-59.5,-13),Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(new Vector2d(39,-10),Math.toRadians(180)))
                .build();
        drive.followTrajectorySequence(ts);
        p.setSugatorPower(0);
        new Thread(this::erectie).start();
        ts = drive.trajectorySequenceBuilder(new Pose2d(new Vector2d(39,-10),Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(new Vector2d(49.6,-31.5),Math.toRadians(180)))
                .build();
        drive.followTrajectorySequence(ts);
        p.kdf(600);
