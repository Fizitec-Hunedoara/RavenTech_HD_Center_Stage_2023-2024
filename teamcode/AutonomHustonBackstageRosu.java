...
public class AutonomHustonBackstageRosu extends LinearOpMode {
...
//                    .waitSeconds(0.2)
        ...
        ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(new Vector2d(39, -12.6), Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(new Vector2d(-59.65,-12.6),Math.toRadians(180)))
        ...
        p.kdf(250);
        p.kdf(400);
        ts = drive.trajectorySequenceBuilder(new Pose2d(new Vector2d(-59.55,-12.6),Math.toRadians(181)))
        ...
        ts = drive.trajectorySequenceBuilder(new Pose2d(new Vector2d(39,-10),Math.toRadians(181)))
                .lineToLinearHeading(new Pose2d(new Vector2d(49.2,-32.3),Math.toRadians(180)))
                .build();
        drive.followTrajectorySequence(ts);
        p.kdf(50);
        new Thread(this::fata_spate).start();
        ...
        ts = drive.trajectorySequenceBuilder(new Pose2d(new Vector2d(49.5,-32.3),Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(new Vector2d(39, -10), Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(new Vector2d(-59,-12.1),Math.toRadians(180)))
                .build();
        drive.followTrajectorySequence(ts);
        p.kdf(100);
        p.setSugatorPower(-0.9);
        ...
        p.kdf(250);
        p.kdf(400);
        ts = drive.trajectorySequenceBuilder(new Pose2d(new Vector2d(-59.5,-12.1),Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(new Vector2d(43,-13),Math.toRadians(180)))
                .build();
        drive.followTrajectorySequence(ts);
        p.setSugatorPower(0);
        p.kobra_kai_retardat(300,5000,15);
