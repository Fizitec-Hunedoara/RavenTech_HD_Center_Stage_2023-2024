...
public class AutonomAlbastruOriginalAproape extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (Objects.equals(varrez, "Dreapta")){
            ts = drive.trajectorySequenceBuilder(startPose)
                    ...
                    .waitSeconds(0.1)
                    .lineToLinearHeading(new Pose2d(new Vector2d(52,30), Math.toRadians(180)))
                    .build();
        }
        ...
        ceva=true;
        if (Objects.equals(varrez, "Mijloc")){
            ts = drive.trajectorySequenceBuilder(new Pose2d(new Vector2d(53,36),Math.toRadians(180)))
