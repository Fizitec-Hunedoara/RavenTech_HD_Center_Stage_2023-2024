...
public class testing extends LinearOpMode {
    ...
    private OpenCvWebcam webcam,webcam2;
...
//                telemetry.addData("Theoretical max FPS", webcam2.getCurrentPipelineMaxFps());
        ...
        webcam2.openCameraDeviceAsync(new OpenCvCamera.AsyncCameraOpenListener() {
            @Override
            public void onOpened() {
                webcam2.setPipeline(aprilTagDetectionPipeline);
                webcam2.startStreaming(Webcam_w,Webcam_h,OpenCvCameraRotation.UPRIGHT);
            }
        ...
        while (opModeIsActive()){
            ...
            if(detections != null)
            {
                telemetry.addData("FPS", webcam2.getFps());
                telemetry.addData("Overhead ms", webcam2.getOverheadTimeMs());
                telemetry.addData("Pipeline ms", webcam2.getPipelineTimeMs());
