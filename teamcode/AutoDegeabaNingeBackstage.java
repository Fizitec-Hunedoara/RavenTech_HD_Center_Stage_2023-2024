...
import org.firstinspires.ftc.teamcode.PachetelNouOpenCV;
import org.firstinspires.ftc.teamcode.Pid_Controller_Adevarat;
import org.firstinspires.ftc.teamcode.SubPrograme;
...
public class AutoDegeabaNingeBackstage extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (Objects.equals(varrez, "Mijloc")) {
            ts = drive.trajectorySequenceBuilder(startPose)
                    ...
                    .forward(7)
                    .lineToLinearHeading(new Pose2d(new Vector2d(51.2,34),Math.toRadians(180)))
                    .build();
        ...
        ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(new Vector2d(39, 13.5), Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(new Vector2d(-59.55,13.5),Math.toRadians(180)))
        ...
        p.kdf(250);
        p.kdf(400);
        ts = drive.trajectorySequenceBuilder(new Pose2d(new Vector2d(-59.55,14.5),Math.toRadians(180)))
        ...
        ts = drive.trajectorySequenceBuilder(new Pose2d(new Vector2d(49.5,32.3),Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(new Vector2d(39, 14.5), Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(new Vector2d(-59.5,14.5),Math.toRadians(180)))
                .build();
        drive.followTrajectorySequence(ts);
        fata_spate();
        p.kdf(300);
        ...
        p.kdf(250);
        p.kdf(400);
        ts = drive.trajectorySequenceBuilder(new Pose2d(new Vector2d(-59.5,14),Math.toRadians(180)))
