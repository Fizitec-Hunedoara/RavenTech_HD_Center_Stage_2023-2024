...
@Autonomous
public class AutonomDeparteAlbastruSingur extends LinearOpMode {
...
//        switchableWebcam.startStreaming(Webcam_w, Webcam_h, OpenCvCameraRotation.UPRIGHT);
        ...
        if (Objects.equals(varrez, "Mijloc")) {
            ts = drive.trajectorySequenceBuilder(startPose)
                    ...
                    .lineToLinearHeading(new Pose2d(new Vector2d(-60.5,36.5),Math.toRadians(180)))
                    .build();
...
//        }
        ...
        ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                ...
                .lineToLinearHeading(new Pose2d(new Vector2d(-56.5,13.5),Math.toRadians(180)))
                .lineTo(new Vector2d(36,13.5))
                .build();
        drive.followTrajectorySequence(ts);
        new Thread(this::ridicare).start();
        if (Objects.equals(varrez, "Dreapta")){
            ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                    .lineToLinearHeading(new Pose2d(new Vector2d(40,31.2), Math.toRadians(180)))
                    .lineToLinearHeading(new Pose2d(new Vector2d(51.25,33.2),Math.toRadians(180)))
                    .build();
            drive.followTrajectorySequence(ts);
        } else if (Objects.equals(varrez, "Stanga")) {
            ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                    .lineToLinearHeading(new Pose2d(new Vector2d(40,43.3), Math.toRadians(180)))
            ...
            ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                    .lineToLinearHeading(new Pose2d(new Vector2d(39,37.6),Math.toRadians(180)))
                    .lineToLinearHeading(new Pose2d(new Vector2d(51.25,37.6),Math.toRadians(180)))
                    .build();
            drive.followTrajectorySequence(ts);
        ...
        if (Objects.equals(varrez, "Dreapta")){
            ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                    .lineToLinearHeading(new Pose2d(new Vector2d(29, 14), Math.toRadians(180)))
                    .lineToLinearHeading(new Pose2d(new Vector2d(-55, 15), Math.toRadians(180)))
                    .build();
        } else if (Objects.equals(varrez, "Stanga")) {
            ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                    .lineToLinearHeading(new Pose2d(new Vector2d(29, 14), Math.toRadians(180)))
