...
@Autonomous
public class AutonomRosuAproapeBun extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (Objects.equals(varrez, "Mijloc")) {
            ts = drive.trajectorySequenceBuilder(startPose)
                    .setReversed(true)
                                .splineTo(new Vector2d(15,-32.5),Math.toRadians(90))
                                .setTangent(Math.toRadians(-90))
                                .splineToConstantHeading(new Vector2d(25, -37.5), Math.toRadians(0))
                                .setTangent(0)
                                .splineToSplineHeading(new Pose2d(49, -37, Math.toRadians(180)), Math.toRadians(0))
                    .build();
...
//        altceva = false;
        ...
        ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .setReversed(false)
                .splineTo(new Vector2d(20,-17),Math.toRadians(180))
                .splineTo(new Vector2d(-60,-17),Math.toRadians(180))
        ...
        ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .setReversed(true)
                .splineTo(new Vector2d(25,-14.5),Math.toRadians(0))
