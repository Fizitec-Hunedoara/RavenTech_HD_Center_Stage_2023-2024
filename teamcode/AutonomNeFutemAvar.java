...
@Autonomous
public class AutonomNeFutemAvar extends LinearOpMode {
...
//                }
            ...
            if (Objects.equals(varrez, "Stanga")) {
                ts = drive.trajectorySequenceBuilder(startPose)
                        .lineToLinearHeading(new Pose2d(new Vector2d(-55.5, -27), Math.toRadians(205)))
...
//                            new Thread(this::erectie_proasta).start())
                ...
                ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                        .lineToLinearHeading(new Pose2d(new Vector2d(-56,-13),Math.toRadians(180)))
                        .setReversed(true)
                        .splineTo(new Vector2d(-20,-13),Math.toRadians(0))
