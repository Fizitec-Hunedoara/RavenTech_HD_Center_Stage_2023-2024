...
@Autonomous
public class AutonomAlbastruSimpluAproape extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (Objects.equals(varrez, "Mijloc")) {
            ts = drive.trajectorySequenceBuilder(startPose)
                    ...
                    .lineToLinearHeading(new Pose2d(new Vector2d(48,36),Math.toRadians(180)))
        ...
        if (Objects.equals(varrez, "Dreapta")){
            ts = drive.trajectorySequenceBuilder(startPose)
                    ...
                    .lineToLinearHeading(new Pose2d(new Vector2d(48,30), Math.toRadians(180)))
