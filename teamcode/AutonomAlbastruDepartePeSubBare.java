...
@Autonomous
public class AutonomAlbastruDepartePeSubBare extends LinearOpMode {
...
//        }
        ...
        ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                ...
                .lineToLinearHeading(new Pose2d(new Vector2d(-56.5,56),Math.toRadians(180)))
        ...
        if (Objects.equals(varrez, "Dreapta")){
            ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                    .lineToLinearHeading(new Pose2d(new Vector2d(36,33.5), Math.toRadians(180)))
                    .lineToLinearHeading(new Pose2d(new Vector2d(51,33.5), Math.toRadians(180)))
                    .build();
        } else if (Objects.equals(varrez, "Stanga")) {
            ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                    .lineToLinearHeading(new Pose2d(new Vector2d(36,41.25), Math.toRadians(180)))
                    .lineToLinearHeading(new Pose2d(new Vector2d(51,41.25), Math.toRadians(180)))
                    .build();
        } else if (Objects.equals(varrez, "Mijloc")) {
            ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                    .lineToLinearHeading(new Pose2d(new Vector2d(36,35.5),Math.toRadians(180)))
                    .lineToLinearHeading(new Pose2d(new Vector2d(51,35.5),Math.toRadians(180)))
                    .build();
        }
        drive.followTrajectorySequence(ts);
        p.kdf(100);
        ...
        if (Objects.equals(varrez, "Dreapta")){
            ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                    .lineToLinearHeading(new Pose2d(new Vector2d(12,56),Math.toRadians(180)))
                    .lineToLinearHeading(new Pose2d(new Vector2d(-54.5,56),Math.toRadians(180)))
                    .lineToLinearHeading(new Pose2d(new Vector2d(-54.5,42),Math.toRadians(180)))
                    .lineToLinearHeading(new Pose2d(new Vector2d(-60,42),Math.toRadians(180)))
        ...
        p.kdf(400);
        ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(new Vector2d(-52.5, 44), Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(new Vector2d(-52.5, 56), Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(new Vector2d(39, 56), Math.toRadians(180)))

                .build();
        drive.followTrajectorySequence(ts);
        new Thread(this::erectie).start();
        ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(new Vector2d(49.175,41),Math.toRadians(180)))
                .build();
        if (Objects.equals(varrez, "Mijloc")){
            ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                    .lineToLinearHeading(new Pose2d(new Vector2d(49.175,41),Math.toRadians(180)))
...
//        }
    ...
    public synchronized void erectie(){
        p.kdf(300);
        altceva = true;
        p.kobra_kai_retardat(1200, 6000,15);
        //p.kdf(50);
        //p.Burdu(690,0.7,p.fata_spate);
        p.kdf(50);
        altceva = false;
