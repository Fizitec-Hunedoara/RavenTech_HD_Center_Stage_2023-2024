...
public class AutonomAlbastruNEoriginalDeparte extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (Objects.equals(varrez, "Mijloc")) {
            ts = drive.trajectorySequenceBuilder(startPose)
                    ...
                    .lineToLinearHeading(new Pose2d(new Vector2d(-60,36),Math.toRadians(180)))
                    .build();
        ...
        ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(new Vector2d(-56,36),Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(new Vector2d(-56,12),Math.toRadians(180)))
        ...
        if (Objects.equals(varrez, "Dreapta")){
            ts = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                    .lineToLinearHeading(new Pose2d(new Vector2d(49,46), Math.toRadians(180)))
                    .build();
        ...
        if (Objects.equals(varrez, "Dreapta")){
            ...
            ts = drive.trajectorySequenceBuilder(new Pose2d(new Vector2d(52,35.5),Math.toRadians(181)))
                    ...
                    .lineToLinearHeading(new Pose2d(new Vector2d(47,46),Math.toRadians(181)))
                    .lineToLinearHeading(new Pose2d(new Vector2d(51.2,46), Math.toRadians(181)))
                    .build();
        } else if (Objects.equals(varrez, "Mijloc")) {
            ts = drive.trajectorySequenceBuilder(new Pose2d(new Vector2d(52,32),Math.toRadians(181)))
                    ...
                    .lineToLinearHeading(new Pose2d(new Vector2d(47,37.95),Math.toRadians(181)))
                    .lineToLinearHeading(new Pose2d(new Vector2d(51.2,37.95),Math.toRadians(181)))
                    .build();
        }
        drive.followTrajectorySequence(ts);
        p.kdf(300);
